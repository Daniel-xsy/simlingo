#!/usr/bin/env python3
"""
Shared utilities for language-navigation benchmark generation and visualization.

Contains map caches, geometry helpers, route actionability analysis, instruction
sampling, and XML building blocks used by multiple scripts in this package.
"""
...
# ---------------------------------------------------------------------------
# OpenDRIVE map resolution & cache
# ---------------------------------------------------------------------------
